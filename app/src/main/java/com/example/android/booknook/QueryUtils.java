...
public final class QueryUtils {
    ...
    */
    ...
    /** Return a list of [@link Earthquake} objects that has been built up from parsing
    ...
    try {
        ...
        if (baseJsonResponse.has("items")) {
            ...
            for (int i = 0; i < itemArray.length(); i++) {
                ...
                JSONObject volumeInfo = itemArray.getJSONObject(i).getJSONObject("volumeInfo");
                if (volumeInfo.has("authors")) {
                    if (volumeInfo.has("title"))
                        ...
                        String authors = "";
                        String previewLink = "";
                        // Extract out the title, authors, and preview link
